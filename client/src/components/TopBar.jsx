...
const TopBar = () => {
  return (
    <div className="topbar w-full flex items-center justify-between py-3 md:py-6 px-4">
      ...
      <button className="neon-button p-2 md:p-3 rounded-full bg-black text-lg md:text-2xl lg:text-3xl">
        <FaCamera className="neon-effect" />
      </button>

      {/* Explore Text */}
      <div className="hidden md:flex items-center justify-center flex-grow md:w-2/5 lg:w-1/2">
        <h1 className="text-ascent-1 text-lg md:text-xl lg:text-2xl">
          Explore
        </h1>
      </div>

      {/* Notification Icon with Notification Number */}
      <div className="relative text-lg md:text-2xl lg:text-3xl neon-button p-2 md:p-3 rounded-full bg-black">
