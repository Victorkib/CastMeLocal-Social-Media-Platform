...
const Login = () => {
  ...
  return (
    <div className="bg-bgColor w-full h-[100vh] flex items-center justify-center p-6">
      <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary bg-opacity-75 rounded-3xl overflow-hidden shadow-xl">
        {/* LEFT */}
        ...
        {/* RIGHT */}
        <div className="hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue bg-opacity-75">
